...
@section('meta_infos')
    ...
    <meta name="description" content="Food Junction - Create an Account">
    <meta name="keywords" content="Food Junction, Food, Junction, Dhaka, Sweets, Register, Sign Up">
@endsection

@section('title')
    Food Junction | Sign Up
@endsection
        ...
        <div class="auth-card" id="container">
            ...
            <div class="form-container sign-up">
                <form action="{{ route('register') }}" method="POST" id="registerForm">
                    ...
                    <span class="auth-subtitle">Fill in your details to create your Food Junction account</span>

                    <div class="input-field-group">
                        <input type="text" name="name" id="regName" placeholder="Full Name" value="{{ old('name') }}" required autocomplete="name" />
                    </div>
                    @error('name')
                    ...
                    <div class="input-field-group">
                        <input type="email" name="email" id="regEmail" placeholder="Email Address" value="{{ old('email') }}" required autocomplete="email" />
                    </div>
                    @error('email')
                        <span class="text-danger text-start w-100 ps-1 pb-1" style="font-size: 12px;">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="input-field-group password-field-wrap">
                        <input type="password" name="password_confirmation" id="regPasswordConfirm" placeholder="Confirm Password" required autocomplete="new-password" />
                        <button type="button" class="password-toggle-btn" onclick="togglePasswordVisibility('regPasswordConfirm', this)" aria-label="Toggle password confirmation visibility">
                            <i class="fa-regular fa-eye"></i>
                        </button>
                    </div>
            ...
            <div class="toggle-container d-none d-md-block">
                <div class="toggle">
                    <div class="toggle-panel">
                        <h1>Welcome Back!</h1>
                        <p>Already have an account? Enter your personal details to sign in and enjoy our special delicacies.</p>
